...
namespace AnimalLibrary.Controllers
{
    ...
    public class HabitatsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create(CreateHabitatDTO createdHabitatDto, CancellationToken ct)
        {
        ...
        public async Task<IActionResult> Update(int id, UpdateHabitatDTO updatedHabitatDto, CancellationToken ct)
        {
        ...
        public async Task<IActionResult> GetAnimalsByHabitatId(int id, CancellationToken ct)
        {
